...
export default function SentenceRow({ sentence }: { sentence: Sentence }) {
  ...
  return (
    <div className="cursor-pointer print:cursor-auto" onClick={handleClick}>
      {/* 문장 본문 */}
      <p
        className={`text-sm leading-6 ${textStyle} transition-transform duration-200 hover:scale-101 origin-center`}
      >
        {sentence.text}
      </p>
